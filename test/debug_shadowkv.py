...
"""
Example usage:
OMP_NUM_THREADS=48 torchrun --standalone --nnodes=1 --nproc_per_node 1 test/debug_shadowkv.py --datalen 65536 --method shadowkv --dataset_name "ruler/niah_single_1" --sparse_budget 2048 --rank 160 --chunk_size 8 --model_name "/mnt/cephfs/models/gradientai/Llama-3-8B-Instruct-Gradient-1048k"
"""
...
if __name__ == '__main__':
    ...
    if dist_config.master_process:
        print(colored(f"data_names: ruler/niah_single_1", 'cyan'))
    ...
    dataset = Dataset("ruler/niah_single_1", llm.tokenizer, datalen, num_samples, evaluator.dist_config.rank, evaluator.dist_config.world_size)
    evaluator.test(llm, dataset, f"debug/{model_name.split('/')[-1]}/ruler/niah_single_1_{datalen}_{args.method}_{sparse_budget}_{rank}_{chunk_size}.jsonl", args.method)
