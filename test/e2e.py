...
configs = {
    ...
    "/mnt/cephfs/models/meta-llama/Llama-3.1-8B-Instruct": {
        "60k": {
            "sparse_budget": 1024,
            "min_prompt_len": 1024*60,
            "baseline_bsz": 8,
...
def parse_args() -> Namespace:
    p = ArgumentParser()
    p.add_argument("--model_name", type=str, default="meta-llama/Meta-Llama-3.1-8B-Instruct", choices=["gradientai/Llama-3-8B-Instruct-Gradient-1048k", "/mnt/cephfs/models/meta-llama/Llama-3.1-8B-Instruct", "01-ai/Yi-9B-200K","THUDM/glm-4-9b-chat-1m"])
